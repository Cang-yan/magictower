...
import com.yibingo.race.dal.dao.InvitationRecordsDao;
 ...
 */
@Service
public class  InvitationRecordsBaseService extends ServiceImpl<InvitationRecordsDao, InvitationRecords> {

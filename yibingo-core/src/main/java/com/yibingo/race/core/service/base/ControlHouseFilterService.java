...
public class ControlHouseFilterService{

    public static List<ControlHouse> getListByFilter(ControlHouseBaseService controlHouseBaseService,ControlHouseFilterMapper filterMapper) {

        QueryWrapper<ControlHouse> wrapper = new QueryWrapper<>();
        ...
        Page<ControlHouse> markPage = new Page<>(page, row);

        Page<ControlHouse> resultList = controlHouseBaseService.page(markPage, wrapper);

...
public class LotteryFilterService{

    public static List<Lottery> getListByFilter(LotteryBaseService lotteryBaseService,LotteryFilterMapper filterMapper) {
        ...
        Page<Lottery> markPage = new Page<>(page, row);

        Page<Lottery> resultList = lotteryBaseService.page(markPage, wrapper);

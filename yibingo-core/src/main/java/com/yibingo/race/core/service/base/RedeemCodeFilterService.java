...
public class RedeemCodeFilterService{

    public static List<RedeemCode> getListByFilter(RedeemCodeBaseService redeemCodeBaseService,RedeemCodeFilterMapper filterMapper) {
        ...
        Page<RedeemCode> markPage = new Page<>(page, row);

        Page<RedeemCode> resultList = redeemCodeBaseService.page(markPage, wrapper);

...
public class BoxMetaFilterService{

    public static List<BoxMeta> getListByFilter(BoxMetaBaseService boxMetaBaseService,BoxMetaFilterMapper filterMapper) {

        QueryWrapper<BoxMeta> wrapper = new QueryWrapper<>();
        ...
        Page<BoxMeta> markPage = new Page<>(page, row);

        Page<BoxMeta> resultList = boxMetaBaseService.page(markPage, wrapper);

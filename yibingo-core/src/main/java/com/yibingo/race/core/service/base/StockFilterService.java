...
public class StockFilterService{
    ...
    public static List<Stock> getListByFilter(StockBaseService stockBaseService,StockFilterMapper filterMapper) {
        ...
        Page<Stock> markPage = new Page<>(page, row);

        Page<Stock> resultList = stockBaseService.page(markPage, wrapper);

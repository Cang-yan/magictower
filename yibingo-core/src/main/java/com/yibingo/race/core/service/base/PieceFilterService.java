...
public class PieceFilterService{

    public static List<Piece> getListByFilter(PieceBaseService pieceBaseService,PieceFilterMapper filterMapper) {

        QueryWrapper<Piece> wrapper = new QueryWrapper<>();
        ...
        Page<Piece> markPage = new Page<>(page, row);

        Page<Piece> resultList = pieceBaseService.page(markPage, wrapper);

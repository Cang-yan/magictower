...
public class NotifyFilterService{

    public static List<Notify> getListByFilter(NotifyBaseService notifyBaseService,NotifyFilterMapper filterMapper) {
        ...
        Page<Notify> markPage = new Page<>(page, row);

        Page<Notify> resultList = notifyBaseService.page(markPage, wrapper);

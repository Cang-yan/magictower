...
public class LotteryPrizeFilterService{

    public static List<LotteryPrize> getListByFilter(LotteryPrizeBaseService lotteryPrizeBaseService,LotteryPrizeFilterMapper filterMapper) {

        QueryWrapper<LotteryPrize> wrapper = new QueryWrapper<>();
        ...
        Page<LotteryPrize> markPage = new Page<>(page, row);

        Page<LotteryPrize> resultList = lotteryPrizeBaseService.page(markPage, wrapper);

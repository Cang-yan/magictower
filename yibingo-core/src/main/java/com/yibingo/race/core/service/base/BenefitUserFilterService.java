...
public class BenefitUserFilterService{

    public static List<BenefitUser> getListByFilter(BenefitUserBaseService benefitUserBaseService,BenefitUserFilterMapper filterMapper) {

        QueryWrapper<BenefitUser> wrapper = new QueryWrapper<>();
        ...
        Page<BenefitUser> markPage = new Page<>(page, row);

        Page<BenefitUser> resultList = benefitUserBaseService.page(markPage, wrapper);

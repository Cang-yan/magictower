...
public class PieceComRecordsFilterService {

    public static List<PieceComRecords> getListByFilter(PieceComRecordsBaseService pieceComRecordsBaseService, PieceComRecordsFilterMapper filterMapper) {

        QueryWrapper<PieceComRecords> wrapper = new QueryWrapper<>();
        ...
        Page<PieceComRecords> markPage = new Page<>(page, row);

        Page<PieceComRecords> resultList = pieceComRecordsBaseService.page(markPage, wrapper);

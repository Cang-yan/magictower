...
public class ExchangeRankFilterService{

    public static List<ExchangeRank> getListByFilter(ExchangeRankBaseService exchangeRankBaseService,ExchangeRankFilterMapper filterMapper) {

        QueryWrapper<ExchangeRank> wrapper = new QueryWrapper<>();
        ...
        Page<ExchangeRank> markPage = new Page<>(page, row);

        Page<ExchangeRank> resultList = exchangeRankBaseService.page(markPage, wrapper);

...
public class BadgeHouseFilterService {

    public static List<BadgeHouse> getListByFilter(BadgeHouseBaseService badgeHouseBaseService, BadgeHouseFilterMapper filterMapper) {

        QueryWrapper<BadgeHouse> wrapper = new QueryWrapper<>();
        ...
        Page<BadgeHouse> markPage = new Page<>(page, row);

        Page<BadgeHouse> resultList = badgeHouseBaseService.page(markPage, wrapper);

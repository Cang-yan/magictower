...
public class BoxUncoverRecordsFilterService{

    public static List<BoxUncoverRecords> getListByFilter(BoxUncoverRecordsBaseService boxUncoverRecordsBaseService,BoxUncoverRecordsFilterMapper filterMapper) {

        QueryWrapper<BoxUncoverRecords> wrapper = new QueryWrapper<>();
        ...
        Page<BoxUncoverRecords> markPage = new Page<>(page, row);

        Page<BoxUncoverRecords> resultList = boxUncoverRecordsBaseService.page(markPage, wrapper);

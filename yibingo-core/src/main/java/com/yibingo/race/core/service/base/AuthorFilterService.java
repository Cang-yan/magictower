...
public class AuthorFilterService{

    public static List<Author> getListByFilter(AuthorBaseService authorBaseService,AuthorFilterMapper filterMapper) {
        ...
        Page<Author> markPage = new Page<>(page, row);

        Page<Author> resultList = authorBaseService.page(markPage, wrapper);

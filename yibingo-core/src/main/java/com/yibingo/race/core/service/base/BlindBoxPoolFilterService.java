...
public class BlindBoxPoolFilterService{

    public static List<BlindBoxPool> getListByFilter(BlindBoxPoolBaseService blindBoxPoolBaseService,BlindBoxPoolFilterMapper filterMapper) {

        QueryWrapper<BlindBoxPool> wrapper = new QueryWrapper<>();
        ...
        Page<BlindBoxPool> markPage = new Page<>(page, row);

        Page<BlindBoxPool> resultList = blindBoxPoolBaseService.page(markPage, wrapper);

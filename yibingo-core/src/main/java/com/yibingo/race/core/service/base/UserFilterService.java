...
public class UserFilterService{
    ...
    public static List<User> getListByFilter(UserBaseService userBaseService,UserFilterMapper filterMapper) {
        ...
        if (filterMapper.phone !=null) wrapper.eq("phone",filterMapper.phone);
        if (filterMapper.accountId !=null) wrapper.eq("account_id",filterMapper.accountId);
        if (filterMapper.phoneIn!=null) wrapper.in("phone",filterMapper.phoneIn);
        if (filterMapper.identity !=null) wrapper.eq("identity",filterMapper.identity);
        ...
        Page<User> resultList = userBaseService.page(markPage, wrapper);

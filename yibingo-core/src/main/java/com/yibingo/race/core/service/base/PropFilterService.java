...
public class PropFilterService{

    public static List<Prop> getListByFilter(PropBaseService propBaseService,PropFilterMapper filterMapper) {

        QueryWrapper<Prop> wrapper = new QueryWrapper<>();
        ...
        Page<Prop> markPage = new Page<>(page, row);

        Page<Prop> resultList = propBaseService.page(markPage, wrapper);

...
public class ExchangeRecordsFilterService{

    public static List<ExchangeRecords> getListByFilter(ExchangeRecordsBaseService exchangeRecordsBaseService,ExchangeRecordsFilterMapper filterMapper) {

        QueryWrapper<ExchangeRecords> wrapper = new QueryWrapper<>();
        ...
        Page<ExchangeRecords> markPage = new Page<>(page, row);

        Page<ExchangeRecords> resultList = exchangeRecordsBaseService.page(markPage, wrapper);

...
public class PieceComRuleFilterService{

    public static List<PieceComRule> getListByFilter(PieceComRuleBaseService pieceComRuleBaseService,PieceComRuleFilterMapper filterMapper) {

        QueryWrapper<PieceComRule> wrapper = new QueryWrapper<>();
        ...
        Page<PieceComRule> markPage = new Page<>(page, row);

        Page<PieceComRule> resultList = pieceComRuleBaseService.page(markPage, wrapper);

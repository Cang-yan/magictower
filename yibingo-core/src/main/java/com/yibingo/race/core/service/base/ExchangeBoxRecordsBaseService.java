...
import com.yibingo.race.dal.dao.ExchangeBoxRecordsDao;
 ...
 */
@Service
public class  ExchangeBoxRecordsBaseService extends ServiceImpl<ExchangeBoxRecordsDao, ExchangeBoxRecords> {

...
public class UserInviteFilterService {

    public static List<UserInvite> getListByFilter(UserInviteBaseService userInviteBaseService, UserInviteFilterMapper filterMapper) {
        ...
        if (filterMapper.code != null) wrapper.eq("code", filterMapper.code);
        ...
        Page<UserInvite> markPage = new Page<>(page, row);

        Page<UserInvite> resultList = userInviteBaseService.page(markPage, wrapper);

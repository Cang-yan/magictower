...
import com.yibingo.race.core.service.base.FamilyFilterService;
...
public class FamilyFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            FamilyFilterMapper mapper = new FamilyFilterMapper();
        ...
        return Result.success(FamilyFilterService.getListByFilter(familyBaseService,mapper)).map();
    }

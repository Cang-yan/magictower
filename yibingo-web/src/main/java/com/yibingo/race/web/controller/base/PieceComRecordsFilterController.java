...
import com.yibingo.race.core.service.base.PieceComRecordsFilterService;
 ...
 */
@Api(
        value = "piececomrecords_extends",
        tags = "合成记录扩展管理"
)
@RestController
@RequestMapping("core/piececomrecords/extends")
public class PieceComRecordsFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            PieceComRecordsFilterMapper mapper = new PieceComRecordsFilterMapper();
        ...
        return Result.success(PieceComRecordsFilterService.getListByFilter(pieceComRecordsBaseService,mapper)).map();
    }

...
import com.yibingo.race.core.service.base.PropHourseFilterService;
 ...
 */
@Api(
        value = "prophourse_extends",
        tags = "道具仓库扩展管理"
)
@RestController
@RequestMapping("core/prophourse/extends")
public class PropHourseFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            PropHourseFilterMapper mapper = new PropHourseFilterMapper();
        ...
        return Result.success(PropHourseFilterService.getListByFilter(propHourseBaseService,mapper)).map();
    }

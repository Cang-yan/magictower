...
import com.yibingo.race.core.service.base.PieceHouseFilterService;
 ...
 */
@Api(
        value = "piecehouse_extends",
        tags = "碎片仓库扩展管理"
)
@RestController
@RequestMapping("core/piecehouse/extends")
public class PieceHouseFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            PieceHouseFilterMapper mapper = new PieceHouseFilterMapper();
        ...
        return Result.success(PieceHouseFilterService.getListByFilter(pieceHouseBaseService,mapper)).map();
    }

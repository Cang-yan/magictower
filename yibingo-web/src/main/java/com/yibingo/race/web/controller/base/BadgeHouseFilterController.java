...
import com.yibingo.race.core.service.base.BadgeHouseFilterService;
 ...
 */
@Api(
        value = "badgehouse_extends",
        tags = "徽章仓库扩展管理"
)
@RestController
@RequestMapping("core/badgehouse/extends")
public class BadgeHouseFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            BadgeHouseFilterMapper mapper = new BadgeHouseFilterMapper();
        ...
        return Result.success(BadgeHouseFilterService.getListByFilter(badgeHouseBaseService,mapper)).map();
    }

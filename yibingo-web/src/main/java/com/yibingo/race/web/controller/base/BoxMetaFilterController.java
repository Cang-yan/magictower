...
import com.yibingo.race.core.service.base.BoxMetaFilterService;
 ...
 */
@Api(
        value = "boxmeta_extends",
        tags = "盲盒藏品绑定关系扩展管理"
)
@RestController
@RequestMapping("core/boxmeta/extends")
public class BoxMetaFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            BoxMetaFilterMapper mapper = new BoxMetaFilterMapper();
        ...
        return Result.success(BoxMetaFilterService.getListByFilter(boxMetaBaseService,mapper)).map();
    }

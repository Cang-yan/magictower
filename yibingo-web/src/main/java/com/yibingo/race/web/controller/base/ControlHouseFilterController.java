...
import com.yibingo.race.core.service.base.ControlHouseFilterService;
 ...
 */
@Api(
        value = "controlhouse_extends",
        tags = "管理员仓库扩展管理"
)
@RestController
@RequestMapping("core/controlhouse/extends")
public class ControlHouseFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            ControlHouseFilterMapper mapper = new ControlHouseFilterMapper();
        ...
        return Result.success(ControlHouseFilterService.getListByFilter(controlHouseBaseService,mapper)).map();
    }

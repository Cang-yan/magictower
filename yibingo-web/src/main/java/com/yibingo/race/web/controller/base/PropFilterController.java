...
import com.yibingo.race.core.service.base.PropFilterService;
...
@RestController
@RequestMapping("core/prop/extends")
public class PropFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            PropFilterMapper mapper = new PropFilterMapper();
        ...
        return Result.success(PropFilterService.getListByFilter(propBaseService,mapper)).map();
    }

...
import com.yibingo.race.core.service.base.LotteryRecordsFilterService;
 ...
 */
@Api(
        value = "lotteryrecords_filter",
        tags = "抽奖记录;条件查询"
)
@RestController
@RequestMapping("core/lotteryrecords/filter")
public class LotteryRecordsFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            LotteryRecordsFilterMapper mapper = new LotteryRecordsFilterMapper();
        ...
        return Result.success(LotteryRecordsFilterService.getListByFilter(lotteryRecordsBaseService,mapper)).map();
    }

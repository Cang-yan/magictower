...
import com.yibingo.race.core.service.base.ExchangeRecordsFilterService;
 ...
 */
@Api(
        value = "exchangerecords_extends",
        tags = "藏品交易记录扩展管理"
)
@RestController
@RequestMapping("core/exchangerecords/extends")
public class ExchangeRecordsFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            ExchangeRecordsFilterMapper mapper = new ExchangeRecordsFilterMapper();
        ...
        return Result.success(ExchangeRecordsFilterService.getListByFilter(exchangeRecordsBaseService,mapper)).map();
    }

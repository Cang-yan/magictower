...
import com.yibingo.race.core.service.base.MetaNftFilterService;
 ...
 */
@Api(
        value = "metanft_extends",
        tags = "藏品扩展管理"
)
@RestController
@RequestMapping("core/metanft/extends")
public class MetaNftFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            MetaNftFilterMapper mapper = new MetaNftFilterMapper();
        ...
        return Result.success(MetaNftFilterService.getListByFilter(metaNftBaseService,mapper)).map();
    }

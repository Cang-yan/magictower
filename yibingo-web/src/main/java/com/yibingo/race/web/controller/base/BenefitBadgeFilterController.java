...
import com.yibingo.race.core.service.base.BenefitBadgeFilterService;
 ...
 */
@Api(
        value = "benefitbadge_extends",
        tags = "徽章权益表扩展管理"
)
@RestController
@RequestMapping("core/benefitbadge/extends")
public class BenefitBadgeFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            BenefitBadgeFilterMapper mapper = new BenefitBadgeFilterMapper();
        ...
        return Result.success(BenefitBadgeFilterService.getListByFilter(benefitBadgeBaseService,mapper)).map();
    }

...
import com.yibingo.race.core.service.base.UserInviteFilterService;
 ...
 */
@Api(
        value = "userinvite_extends",
        tags = "用户邀请码扩展管理"
)
@RestController
@RequestMapping("core/userinvite/extends")
public class UserInviteFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            UserInviteFilterMapper mapper = new UserInviteFilterMapper();
        ...
        return Result.success(UserInviteFilterService.getListByFilter(userInviteBaseService,mapper)).map();
    }

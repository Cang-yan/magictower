...
import com.yibingo.race.core.service.base.UserAuthFilterService;
 ...
 */
@Api(
        value = "userauth_extends",
        tags = "用户权限值扩展管理"
)
@RestController
@RequestMapping("core/userauth/extends")
public class UserAuthFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            UserAuthFilterMapper mapper = new UserAuthFilterMapper();
        ...
        return Result.success(UserAuthFilterService.getListByFilter(userAuthBaseService,mapper)).map();
    }

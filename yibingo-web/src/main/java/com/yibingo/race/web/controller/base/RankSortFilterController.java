 ...
 */
@Api(
        value = "ranksort_extends",
        tags = "品质分级,默认概率写进枚举扩展管理"
)
@RestController
@RequestMapping("core/ranksort/extends")
public class RankSortFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            RankSortFilterMapper mapper = new RankSortFilterMapper();
        ...
        return Result.success(RankSortFilterService.getListByFilter(rankSortBaseService,mapper)).map();
    }

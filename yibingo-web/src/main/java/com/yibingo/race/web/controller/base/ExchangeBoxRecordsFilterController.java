...
import com.yibingo.race.core.service.base.ExchangeBoxRecordsFilterService;
 ...
 */
@Api(
        value = "exchangeboxrecords_extends",
        tags = "盲盒购买和抽取记录扩展管理"
)
@RestController
@RequestMapping("core/exchangeboxrecords/extends")
public class ExchangeBoxRecordsFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            ExchangeBoxRecordsFilterMapper mapper = new ExchangeBoxRecordsFilterMapper();
        ...
        return Result.success(ExchangeBoxRecordsFilterService.getListByFilter(exchangeBoxRecordsBaseService,mapper)).map();
    }

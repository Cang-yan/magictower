...
import com.yibingo.race.core.service.base.BoxHouseFilterService;
 ...
 */
@Api(
        value = "boxhouse_extends",
        tags = "盲盒仓库扩展管理"
)
@RestController
@RequestMapping("core/boxhouse/extends")
public class BoxHouseFilterController {
    ...
    public Map<String,Object> getListByFilter(@RequestParam(value = "updateTimeFrom", required = false)Long updateTimeFrom,
            ...
            BoxHouseFilterMapper mapper = new BoxHouseFilterMapper();
        ...
        return Result.success(BoxHouseFilterService.getListByFilter(boxHouseBaseService,mapper)).map();
    }
